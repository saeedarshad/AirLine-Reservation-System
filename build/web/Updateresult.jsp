<%-- 
    ...
    Created on : Nov 5, 2017, 11:52:59 PM
    Author     : saeed
--%>
<%
  ...
  <table class="table .table-condensed table-bordered" style="color:black;font-size:15px">
    <thead>
      ...
      <tr>
       ...
       <form action="Mainupdate.jsp" Method="post" >
        ...
        <TD style="color:lightskyblue"><b> <%= result.getString("flightid") %> </b></td>
                ...
                <TD style="color:lightskyblue"> <%= result.getString("economyseat")%></TD> 
            
               
                    <TD style="color:lightskyblue"> <%= result.getString("businessseat") %></TD> 
                
                    <TD style="color:lightskyblue"> <%= result.getString("firstseat") %></TD>
   
                   <TD style="color:lightskyblue"> <%= result.getString("economyfare")%></TD> 
                ...
                <td class="text-center"><button style="margin-left:15px"class="btn btn-success btn-md" type="submit">Edit</button></td>
              </form>
                </tr>
